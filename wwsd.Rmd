...
#### about database
This database contains corespondences between writing and phonology. The main goal for this database is to investigate homography and homophony variability and find some correlations between that and some other linguistic and sociolinguistics variables.
